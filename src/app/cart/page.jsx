...
export default function ProfessionalSippureCart() {
...
const product = {
  ...
  const herbs = [
    { name: "Chamomile", image: "3.webp", color: "bg-yellow-100 border-yellow-300" },
    { name: "Butterfly Tea", image: "butterfly.jpg", color: "bg-blue-100 border-blue-300" },
    { name: "Rose Tea", image: "rose-bio.jpg", color: "bg-pink-100 border-pink-300" },
    { name: "Matcha ", image: "Matcha.jpg", color: "bg-red-100 border-red-300" }
  ];
  ...
  const getSavings = () => {
    return (product.originalPrice - product.basePrice) * quantity;
  };
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button 
                ...
                className={`p-2 transition-colors ${isFavorited ? 'text-red-500' : 'text-gray-600 hover:text-red-500'}`}
              >
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-4 gap-3">
              {product.galleryImages.map((image, index) => (
                <div key={index} className="aspect-square rounded-lg overflow-hidden bg-white shadow-md cursor-pointer hover:shadow-lg transition-shadow">
                  <img 
                    src={image} 
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              ...
              <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-sm">
                ...
                <span className="text-xs text-gray-600">Orders over Rs 500</span>
              </div>
              <div className="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-sm">
          ...
          <div className="space-y-8">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="space-y-2">
                  ...
                  <div className="text-emerald-600 font-semibold">
                    You save Rs {getSavings().toLocaleString()} ({Math.round(((product.originalPrice - product.basePrice) / product.originalPrice) * 100)}% off)
                  </div>
                </div>
            ...
            {/* Herb Selection */}
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-gray-900">Choose Your Herb Blend</h3>
            ...
            {/* Sweetness Level */}
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-gray-900">Sweetness Level</h3>
