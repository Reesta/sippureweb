...
const products = [
  {
    ...
    image: '/MenuHIbis.png',
    description:
      'A tart and tangy herbal infusion made from dried hibiscus flowers...',
    benefits: [
  ...
  },
  {
    ...
    slug: 'iced-matcha',
    price: 300,
    image: '/MatchaMenu.png',
    description:
      'Finely ground green tea leaves whipped into a smooth iced drink...',
    benefits: [
      'Boosts metabolism',
  ...
  },
  {
    ...
    image: '/PeachIced.png',
    description:
      'Sweet and fruity peach-flavored black tea served ice-cold...',
    benefits: [
  ...
  },
  {
    ...
    slug: 'chamomile-tea',
    price: 250,
    image: '/ChamomileTea.png',
    description:
      'A soothing caffeine-free herbal tea made from chamomile flowers...',
    benefits: [
  ...
  },
  {
    ...
    slug: 'butterfly-tea',
    price: 300,
    image: '/MenuButterfly.png',
    description:
      'Also known as butterfly pea flower tea, this naturally blue tea...',
    benefits: [
  ...
  },
  {
    ...
    image: '/Herbaltea.png',
    description:
      'A caffeine-free blend of herbs and spices, designed for wellness...',
    benefits: [
      'Customizable blends',
      'Great for digestion',
...
export default function MenuAndDetailPage() {
  ...
  if (selectedProduct) {
    return (
      <div
        id="Menu"
        className="py-12 px-4 sm:px-6 lg:px-8 bg-[#f3f8e9] min-h-screen"
      >
                ...
                <div className="bg-yellow-50 p-4 rounded-xl border border-yellow-100 shadow-sm">
                  ...
                  <ul className="text-gray-800 space-y-1">
                    ...
                    <li>
                      ...
                      {selectedProduct.nutritionalInfo.protein}
                    </li>
                    <li>
                      <strong>Carbs:</strong>{' '}
                      {selectedProduct.nutritionalInfo.carbs}
                    </li>
                    <li>
                      <strong>Fat:</strong> {selectedProduct.nutritionalInfo.fat}
                    </li>
                  </ul>
                </div>
  ...
  return (
    <section
      id="menu"
      className="py-12 px-4 bg-[#f3f8e9] min-h-screen"
    >
              ...
              >
                <div className="aspect-[3/3] relative">
                  <Image
                    ...
                    sizes="(max-width: 900px) 700vw, (max-width: 1200px) 50vw, 33vw"
                  />
                </div>
              </button>
